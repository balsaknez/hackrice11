...
def get_landmarks(path_to_image):
    p = r"C:\Users\milja\Desktop\Video_utils\Video_utils\shape_predictor_68_face_landmarks.dat"
...
def frame_extractor(path_to_video,html):
    ...
    while(cap.isOpened()):
        ...
        if html:
           ...
           nm = "C:/Users/milja/Desktop/cutframes8/"+str(i).zfill(6)+".jpg"
           cropped.save(nm, "JPEG")
        elif 1==1:
           lands = 0
           lands, success = get_landmarks(im_name)
           keypoint_drawer(lands, im_name)
           cropped = crop_image(lands,im_name)
           #print(cropped.size)
           nm = "C:/Users/milja/Desktop/cutframes4/"+str(i).zfill(6)+".jpg"
           cropped.save(nm, "JPEG")
        i+=1
        print("Image: ",i)
